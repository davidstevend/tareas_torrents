                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    ...
                                    <p class="mt-3 mb-0 text-muted text-sm">
                                        ...
                                        <span class="text-nowrap">Usuarios registrados en Plataforma</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    ...
                                    <p class="mt-3 mb-0 text-muted text-sm">
                                        <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> 9.48%</span>
                                        <span class="text-nowrap">Tareas Registradas</span>
                                    </p>
                                </div>
                            </div>
                        </div>
