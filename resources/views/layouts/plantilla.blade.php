                ...
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item mr-auto">
                        <a class="navbar-brand" href="{{ route('home') }}">
                            <img class="brand-logo" alt="modern admin logo" src="{{ asset('logos/tua.png') }}">
                        ...
                        @auth
                            <li class="dropdown dropdown-user nav-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i
                                            class="ft-user"></i> Editar Perfil</a>
                            ...
                            <li class="dropdown dropdown-notification nav-item">
                                <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i
                                    ...
                                    <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow"> {{ Auth::user()->userTaskPending() }}</span>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                    <li class="dropdown-menu-header">
                                        <h6 class="dropdown-header m-0">
                                            <span class="grey darken-2">todas las Tareas</span>
                                        </h6>
                                    ...
                                    <li class="scrollable-container media-list w-100">
                                        ...
                                        {{-- Auth::user()->userTasks() --}}
                                       @foreach(Auth::user()->userTasks() as $task) 
                                          <a href="javascript:void(0)">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-heading yellow darken-3">{{ $task->task }}</h6>
                                                    <p class="notification-text font-small-3 text-muted">{{ $task->description }}</p>
                                                    <small>
                                                        <time class="media-meta text-muted"
                                                            datetime="2015-06-11T18:29:20+08:00">{{ $task->expiration_date }}</time>
                                                    </small>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                      href="{{ url('tasks') }}">Ver Todas las Tareas</a></li>
                                </ul>
                            </li>
